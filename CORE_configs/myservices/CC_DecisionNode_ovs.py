...
"""            
        if filename == cls.configs[2]:
            cfg = "#!/bin/sh\n"
            cfg += "# auto-generated by CC_DecisionNode_OCS service\n"
            ...
            for iface in node.get_ifaces(control=False):
                ...
                cfg += "## Remove ip addresses of eths.\n"
                ...
                portnum += 1
            cfg += "## Set the default device to the bridge so that it can handle where packets go\n"
